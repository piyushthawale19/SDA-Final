  ...
  return (
    <main className="h-screen flex flex-col bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white">
      ...
      <div className="flex flex-grow overflow-hidden">
        ...
        <section className="left flex flex-col min-w-64 max-w-64 bg-slate-100 dark:bg-slate-600 overflow-hidden border-r border-slate-300 dark:border-slate-700">
          <div className="explorer flex-grow overflow-auto">
